...
if [[ "$answer" == "n" || "$answer" == "N" ]]; then
    ...
    clear
    echo "Please restart the setup and the terminal. If you still get an error, try installing the node manually or restart your system"
    exit 0
fi
...
echo "2 = Disable"
echo
read -p "Answer with 1/2 " answer4
...
if [[ "$answer4" == "1" ]]; then
    ...
    echo
    echo "You can get your API key here"
